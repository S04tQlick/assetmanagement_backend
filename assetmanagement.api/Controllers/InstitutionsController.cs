...
public class InstitutionsController(IInstitutionService service)
    : BaseApiController<InstitutionsModel, InstitutionsResponse, InstitutionsCreateRequest, InstitutionsUpdateRequest>(
        service)
{
    [ApiExplorerSettings(IgnoreApi = true)]
    public override Task<ActionResult<IEnumerable<InstitutionsResponse>>> GetByInstitutionId(Guid institutionId) =>
        Task.FromResult<ActionResult<IEnumerable<InstitutionsResponse>>>(NotFound());
}
