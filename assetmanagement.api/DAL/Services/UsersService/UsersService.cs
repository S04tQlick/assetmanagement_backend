...
public class UsersService(IRepositoryQueryHandler<UsersModel> repository, IMapper mapper)
    : ServiceQueryHandler<UsersModel, UsersResponse, UsersCreateRequest, UsersUpdateRequest>(repository, mapper), IUsersService;
...
//     }
//
//     public async Task<UsersModel> CreateAsync(UsersCreateRequest request)
//     {
...
//         return mapper.Map<UsersModel>(created);
//     }
//
//     public async Task<UsersModel> UpdateAsync(Guid id, UsersUpdateRequest request)
//     {
...
//         return mapper.Map<UsersModel>(updated);
//     }
//     
