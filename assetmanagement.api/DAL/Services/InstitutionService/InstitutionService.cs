...
public class InstitutionService(IInstitutionRepository repo, IMapper mapper) : IInstitutionService
{
    public async Task<IEnumerable<InstitutionsResponse>> GetAllAsync()
    {
        var entities = await repo.GetAllAsync();
        return mapper.Map<IEnumerable<InstitutionsResponse>>(entities);
    } 

    public async Task<InstitutionsResponse?> GetByIdAsync(Guid id)
    {
        var entity = await repo.GetByIdAsync(id);
        return entity == null ? null : mapper.Map<InstitutionsResponse>(entity);
    } 
    ...
    public async Task<int> CreateAsync(InstitutionsCreateRequest request)
    {
    ...
    public async Task<int> UpdateAsync(Guid id, InstitutionsUpdateRequest request)
    {
