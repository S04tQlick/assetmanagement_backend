...
public class RoleService(IRoleRepository repo, IMapper mapper) : IRoleService
{
    ...
    public async Task<int> CreateAsync(RolesCreateRequest request)
    {
    ...
    public async Task<int> UpdateAsync(Guid id, RolesUpdateRequest request)
    {
